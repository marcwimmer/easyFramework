...
<HTML>
	<HEAD>
		...
		function mLoadAnswer(ans_id) {
			...
			//Besonderheit: 
			//Abhängig vom Fragentyp (ans_aty_id) gibt es verschiedene XML-Dialoge, die geladen werden müssen:
		...
		function mAddAnswer() {
			...
			if (sLastQst_id == "" | sLastQst_id == null) {
				efMsgBox("Bitte wählen Sie eine Frage aus!", "INFO");
				return;
			}
		...
		function mAddAnswerValue() {
			...
			if (sLastAns_id == "" | sLastAns_id == null) {
				efMsgBox("Bitte wählen Sie eine Antwort aus!", "INFO");
				return;
			}
		...
		function mDeleteAnswerValue() {
			if (sLastVal_id == "" | sLastVal_id == null) {
				efMsgBox("Bitte wählen Sie einen Antwortwert aus!", "INFO");
				return;
			}
		...
		function mHandleSaveChanges() {
			...
			if (gbAnyRegisteredXmlDialogDirty()) {
				if (efMsgBox("Änderungen speichern?", "QUESTION", "YESNO") == "YES") {
					mOnSave();
				}
			}
	...
	<body onload="mOnLoad();">
		...
		<div style="LEFT:0px; OVERFLOW:hidden; Width:50%; POSITION:absolute;TOP:54%; HEIGHT:5%">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<ef:efButton id="EfButton_DeleteQuestion" runat="server" sText="Löschen" sOnClick="mDeleteQuestion();"></ef:efButton>
		</div>
		...
		<div style="LEFT:50%; OVERFLOW:hidden; Width:30%; POSITION:absolute;TOP:54%; HEIGHT:5%">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<ef:efButton id="EfButton_DeleteAnswer" runat="server" sText="Löschen" sOnClick="mDeleteAnswer();"></ef:efButton>
		</div>
		...
		<div style="LEFT:80%; OVERFLOW:hidden; Width:20%; POSITION:absolute;TOP:54%; HEIGHT:5%">
			...
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<ef:efButton id="EfButton_DeleteAnswerValue" runat="server" sText="Löschen" sOnClick="mDeleteAnswerValue();"></ef:efButton>
		</div>
